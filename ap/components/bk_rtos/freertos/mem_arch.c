...
#if CONFIG_TZ
#define PSRAM_HEAP_START_ADDRESS    (void*)(CONFIG_AP_PSRAM_HEAP_ADDR + SOC_ADDR_OFFSET)
#else
#define PSRAM_HEAP_START_ADDRESS    (void*)(CONFIG_AP_PSRAM_HEAP_ADDR)
#endif
#define PSRAM_HEAP_END_ADDRESS      ((uint8_t*)PSRAM_HEAP_START_ADDRESS + CONFIG_AP_PSRAM_HEAP_SIZE)
#endif

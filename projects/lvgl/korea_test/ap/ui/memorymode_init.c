...
void destroy_page_memorymode(bk_lv_ui_t *bk_ui)
{
    ...
    uiPageUnloadImage(PAGE_MEMORYMODE);
}
...
void init_page_memorymode(bk_lv_ui_t * bk_ui) {
    ...
    _img_set_src_timed(bk_ui->memorymode_title, "/images/memorymode_title.png");
    ...
    _img_set_src_timed(bk_ui->memorymode_imageview3, "/images/exit_bt.png");
    ...
    _img_set_src_timed(bk_ui->memorymode_imageview4, "/images/memory_title_line.png");
    ...
    _img_set_src_timed(bk_ui->memorymode_memorybox0, "/images/memory_box.png");
    ...
    _img_set_src_timed(bk_ui->memorymode_imageview81, "/images/memory_left.png");
    ...
    _img_set_src_timed(bk_ui->memorymode_imageview89, "/images/memory_right.png");
    ...
    _img_set_src_timed(bk_ui->memorymode_imageview92, "/images/ok.png");
    ...
    _img_set_src_timed(bk_ui->memorymode_deleteim, "/images/delete.png");
...
rendererFuncStatus_t init_page_memorymode_with_step(bk_lv_ui_t *bk_ui)
{
    ...
    switch (currentStep)
    {
        case RENDER_STEP_CREATE_PAGE :
        {
            ...
            bk_printf(TAG "[RENDER][MEMORYMODE] start tick=%lu\n", (unsigned long)renderStartTick);
            ...
            bk_printf(TAG "[RENDER][MEMORYMODE] CREATE_PAGE done elapsed=%lu ms\n",
        ...
        case RENDER_STEP_CREATE_CHILD :
        {
            ...
            bk_printf(TAG "[RENDER][MEMORYMODE] CREATE_CHILD start\n");
            ...
            bk_printf(TAG "[RENDER][MEMORYMODE] CREATE_CHILD done elapsed=%lu ms total=%lu ms\n",
                      (unsigned long)lv_tick_elaps(stepStartTick),
        ...
        case RENDER_STEP_CACHE_IMAGE :
        {
            ...
            bk_printf(TAG "[PREWARM][MEMORYMODE] CACHE_IMAGE start (%lu images)\n", (unsigned long)imageCount);
            ...
            if(currentImageStep < imageCount)
            {
                ...
                if(res != LV_RESULT_OK)
                {
                    bk_printf(TAG "[PREWARM][MEMORYMODE] image %lu/%lu FAILED res=%d elapsed=%lu ms path=%s\n",
                              (unsigned long)(currentImageStep + 1),
                              (unsigned long)imageCount,
                              (int)res,
                ...
                bk_printf(TAG "[PREWARM][MEMORYMODE] image %lu/%lu OK elapsed=%lu ms path=%s\n",
                          (unsigned long)(currentImageStep + 1),
                          (unsigned long)imageCount,
                          (unsigned long)imageElapsed,
                          imagePath);
            ...
            bk_printf(TAG "[PREWARM][MEMORYMODE] all images done count=%lu total=%lu ms\n",
                      (unsigned long)imageCount,
                      (unsigned long)lv_tick_elaps(renderStartTick));
        ...
        case RENDER_STEP_ATTACH_EVENT :
        {
            ...
            bk_printf(TAG "[RENDER][MEMORYMODE] ATTACH_EVENT start\n");
            ...
            lv_obj_add_event_cb(bk_ui->memorymode_backbt, memorymode_backbt_event_cb, LV_EVENT_PRESSED, NULL);
            lv_obj_add_event_cb(bk_ui->memorymode_memory_check1bt, memorymode_memory_check1bt_event_cb, LV_EVENT_PRESSED, NULL);
            lv_obj_add_event_cb(bk_ui->memorymode_memory_check2bt, memorymode_memory_check2bt_event_cb, LV_EVENT_PRESSED, NULL);
            lv_obj_add_event_cb(bk_ui->memorymode_memory_check3bt, memorymode_memory_check3bt_event_cb, LV_EVENT_PRESSED, NULL);
            lv_obj_add_event_cb(bk_ui->memorymode_memory_check4bt, memorymode_memory_check4bt_event_cb, LV_EVENT_PRESSED, NULL);
            lv_obj_add_event_cb(bk_ui->memorymode_memoryleftbt, memorymode_memoryleftbt_event_cb, LV_EVENT_PRESSED, NULL);
            lv_obj_add_event_cb(bk_ui->memorymode_memory1bt, memorymode_memory1bt_event_cb, LV_EVENT_PRESSED, NULL);
            lv_obj_add_event_cb(bk_ui->memorymode_memory2bt, memorymode_memory2bt_event_cb, LV_EVENT_PRESSED, NULL);
            lv_obj_add_event_cb(bk_ui->memorymode_memory3bt, memorymode_memory3bt_event_cb, LV_EVENT_PRESSED, NULL);
            lv_obj_add_event_cb(bk_ui->memorymode_memoryrightbt, memorymode_memoryrightbt_event_cb, LV_EVENT_PRESSED, NULL);
            lv_obj_add_event_cb(bk_ui->memorymode_okbt, memorymode_okbt_event_cb, LV_EVENT_PRESSED, NULL);
            lv_obj_add_event_cb(bk_ui->memorymode_deletebt, memorymode_deletebt_event_cb, LV_EVENT_PRESSED, NULL);

            bk_printf(TAG "[RENDER][MEMORYMODE] ATTACH_EVENT done elapsed=%lu ms\n",
                      (unsigned long)lv_tick_elaps(stepStartTick));
        ...
        case RENDER_STEP_DONE :
        {
            ...
            bk_printf(TAG "[RENDER][MEMORYMODE] DONE total=%lu ms\n", (unsigned long)totalElapsed);
        ...
        default :
        {
            bk_printf(TAG "[RENDER][MEMORYMODE] INVALID STEP: %lu\n", (unsigned long)currentStep);
            return RENDERER_FUNC_FAILED;
        }
    }
}
